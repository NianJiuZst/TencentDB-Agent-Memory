...
LongMemEval backend query p50/p95 increases from 0.727/1.867 ms to
1.444/2.620 ms when the candidate limit grows from 5 to 30. LoCoMo increases
from 0.382/0.586 ms to 0.845/1.135 ms. These local in-memory measurements are
...
dedicated branch over MemoryCore v2 source. The structured receipts contain
full source revisions; the exact LongMemEval and LoCoMo reruns used
\code{43f3b47} and \code{abea421}, respectively. Unit tests cover disabled-path
