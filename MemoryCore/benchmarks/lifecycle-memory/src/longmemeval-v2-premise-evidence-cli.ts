...
import type { PremiseEvidencePhaseAdmission } from "./longmemeval-v2-premise-evidence-baseline-runner.js";
import type { LongMemEvalV2PremiseEvidencePhase } from "./longmemeval-v2-premise-evidence-protocol.js";
import { runLongMemEvalV2PremiseEvidence } from "./longmemeval-v2-premise-evidence-runner.js";

const { values } = parseArgs({
  options: {
    "data-root": { type: "string" }, phase: { type: "string" },
    "pre-score-commit": { type: "string" }, "baseline-cases": { type: "string" },
    "baseline-summary": { type: "string" }, "cases-out": { type: "string" },
    "summary-out": { type: "string" }, authorization: { type: "string" },
  },
});
if (!values["data-root"] || !values.phase || !values["pre-score-commit"]
  ...
  throw new Error(
    "usage: --data-root <dir> --phase <development|validation|test> --pre-score-commit <sha>"
...
const result = await runLongMemEvalV2PremiseEvidence({
