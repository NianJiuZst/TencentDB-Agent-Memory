...
We ask three questions. \textbf{RQ1:} can bounded correction links improve stale-exposed answers without increasing the injection budget? \textbf{RQ2:} does a richer policy selected by direct memory feedback also dominate after answer generation? \textbf{RQ3:} can a predeclared promotion rule detect and reject a proxy-selected regression? These questions separate mechanism efficacy, optimization efficacy, and deployment safety.
