...
\section{Research Trajectory Before the Broad Experiment}

Table~\ref{tab:directions} summarizes D1--D15. These are retained negative and near-miss results, not a sequence in which every later number is better.

\begin{table}[H]
\centering
\scriptsize
\resizebox{\linewidth}{!}{%
\begin{tabular}{p{0.55cm}p{3.0cm}p{7.2cm}p{2.6cm}}
\toprule
...
\bottomrule
\end{tabular}}
\caption{Research directions D1--D15. Development results are never relabeled as confirmation.}
